...
const SignUpForm = ({ onSignUp }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(response.data.status && response.data.msg==="Registered Successfully"){
        setSuccessMessage('User Regsitered Successfully')
  ...
  return (
    <div className="grid-container">
      <div className="form-container">
        ...
        {isUserExist && <div className="error-message">{'User Already Exists'}</div>}
